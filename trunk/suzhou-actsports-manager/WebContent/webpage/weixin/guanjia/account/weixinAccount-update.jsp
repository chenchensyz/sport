 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinAccountController.do?doUpdate" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					...
					<td class="value">
					     	 <input id="host" name="host" type="text" style="width: 150px" class="inputxt" value='${weixinAccountPage.host}'  datatype="*">
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">公众帐号host域名</label>
					</td>
				</tr>
			</table>
		</t:formvalid>
