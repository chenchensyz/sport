...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="weixinExpandconfigList" checkbox="true" fitColumns="true" title="扩展接口管理" actionUrl="weixinExpandconfigController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="关键字"  field="keyword"    queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="功能类"  field="classname"   queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="功能名称"  field="name"     queryMode="single"  width="120"></t:dgCol>
