		 		...
		 		<div class="inner" style="width:660px">
					...
					<table cellpadding="0" cellspacing="1" class="formtable">
						...
						<tr>
							...
							<td class="value">
								<input class="inputxt" id="url" name="url" style="width: 300px" value="${cmsArticlePage.url}"/>
								<span class="Validform_checktip"></span>
								<label class="Validform_label" style="display: none;">外链地址</label>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td class="value">
								<textarea class="inputxt" id="summary" name="summary" style="width: 300px">${cmsArticlePage.summary}</textarea>
								<span class="Validform_checktip"></span>
						...
						<tr>
							...
							<td class="value">
								<input class="inputxt" id="articleSort" name="articleSort" style="width: 300px" value="${cmsArticlePage.articleSort}">
								<span class="Validform_checktip"></span>
						...
						<tr>
							...
							<td class="value">
								 <textarea name="content" id="content" style="width: 600px;height:300px">${cmsArticlePage.content}</textarea>
							    <script type="text/javascript">
