...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="weixinCmsSiteList" checkbox="true" fitColumns="false" title="微站点信息" actionUrl="weixinCmsSiteController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgCol title="站点模板样式"  field="siteTemplateStyle"  dictionary="t_cms_weixin_style,id,template_name,orgCode='${ResourceUtil.getUserSystemData(DataBaseConstant.SYS_ORG_CODE)}'" hidden="true"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="组织机构"  field="orgCode"  hidden="false"  queryMode="single"  width="120"></t:dgCol>
   <t:dgCol title="域名"  field="domain"  width="120"></t:dgCol>
   <t:dgCol title="备案信息"  field="content"  width="120"></t:dgCol>
