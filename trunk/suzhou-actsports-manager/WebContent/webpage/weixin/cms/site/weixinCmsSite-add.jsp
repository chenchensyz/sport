		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
							...
							<t:dictSelect field="siteTemplateStyle"  dictTable="t_cms_weixin_style where orgCode = '${ResourceUtil.getUserSystemData(DataBaseConstant.SYS_ORG_CODE)}'" dictField="id" dictText="template_name" defaultVal="${weixinCmsSitePage.siteTemsplateStyle}" ></t:dictSelect>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	<input id="domain" name="domain" type="text" style="width: 300px" class="inputxt" >
							<span class="Validform_checktip"></span>
