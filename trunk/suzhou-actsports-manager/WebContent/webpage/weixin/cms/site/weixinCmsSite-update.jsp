...
<html>
 ...
 <div class="appmsg editing">
  ...
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="weixinCmsSiteController.do?doUpdate" tiptype="1">
					...
					<input id="orgCode" name="orgCode" type="hidden" value="${weixinCmsSitePage.orgCode }">
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				...
				<tr>
					...
					<td class="value">
							...
							<t:dictSelect field="siteTemplateStyle"  dictTable="t_cms_weixin_style where orgCode = '${ResourceUtil.getUserSystemData(DataBaseConstant.SYS_ORG_CODE)}'" dictField="id"   dictText="template_name" defaultVal="${weixinCmsSitePage.siteTemplateStyle}"></t:dictSelect>
							<span class="Validform_checktip"></span>
				...
				<tr>
					...
					<td class="value">
					     	<input id="domain" name="domain" type="text" value="${weixinCmsSitePage.domain}" style="width: 300px" class="inputxt" >
							<span class="Validform_checktip"></span>
							<label class="Validform_label" style="display: none;">域名</label>
					</td>
				</tr>
				<tr>
					<td align="right">
					...
					<td class="value">
						<textarea  rows="7" cols="60" name="content" id="content">${weixinCmsSitePage.content}</textarea>
						<span class="Validform_checktip"></span>
					</td>
				</tr>
			</table>
