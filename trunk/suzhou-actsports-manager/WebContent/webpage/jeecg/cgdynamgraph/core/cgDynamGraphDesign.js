...
function doPie(){
    ...
    for(var key in businessMap){
        ...
        echarts.init($('<div style="width: 85%;height:300px;"></div>').appendTo("#canvasDiv")[0]).setOption(option);
    }
    $('<div style="width: 85%;height:300px;"></div>').appendTo("#canvasDiv")[0];
    $("#gallery_data").addClass("test");
}
function doColumn(){
	DEFAULT_ = {
