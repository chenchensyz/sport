...
<script type="text/javascript">
	$('#addcgDynamGraphConfigParamBtn').linkbutton({   
	    iconCls: 'icon-add'  
	});  
	$('#delcgDynamGraphConfigParamBtn').linkbutton({   
	    iconCls: 'icon-remove'  
	}); 
	$('#addcgDynamGraphConfigParamBtn').bind('click', function(){   
	...
	$('#delcgDynamGraphConfigParamBtn').bind('click', function(){   
      	$("#add_cgDynamGraphConfigParam_table").find("input:checked").parent().parent().remove();   
        resetTrNum('add_cgDynamGraphConfigParam_table'); 
    }); 
...
<div style="padding: 3px; height: 25px; width: auto;" class="datagrid-toolbar"><a id="addcgDynamGraphConfigParamBtn" href="javascript:void(0);">添加</a> <a id="delcgDynamGraphConfigParamBtn" href="javascript:void(0);">删除</a></div>
<div style="width: auto; height: 150px; overflow-y: auto; overflow-x: scroll;">
<table border="0" cellpadding="2" cellspacing="0" id="cgDynamGraphConfigParam_table">
	<tr bgcolor="#E6E6E6">
	...
	<tbody id="add_cgDynamGraphConfigParam_table">
