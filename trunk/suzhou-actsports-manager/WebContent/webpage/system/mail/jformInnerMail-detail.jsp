							...
							<table>
								<tr style="height: 34px;">
									<c:forEach items="${documents}" var="vdocument">
											<td><a href="commonController.do?viewFile&fileid=${vdocument.id}&subclassname=com.hbasesoft.framework.manager.web.system.pojo.base.JformInnerMailAttach" title="下载">${vdocument.attachmenttitle}.${vdocument.extend}</a></td>
									</c:forEach>
								</tr>
					        </table>
						</td>
