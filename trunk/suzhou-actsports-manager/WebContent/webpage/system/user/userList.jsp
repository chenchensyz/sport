...
<t:datagrid name="userList" title="管理员管理" actionUrl="userController.do?datagrid" 
    fit="true" fitColumns="true" idField="id" queryMode="group" sortName="createDate" sortOrder="desc">
	<t:dgCol title="common.id" field="id" hidden="true"></t:dgCol>
	<t:dgCol title="管理员" sortable="false" field="userName" query="true"></t:dgCol>
	<t:dgCol title="common.surname" field="realName" query="false"></t:dgCol>
	...
	<t:dgCol title="department.manage" sortable="false" field="userOrgList.tsDepart.departname" query="false"></t:dgCol>
	...
	<t:dgToolBar title="common.add.param" langArg=" " url="userController.do?addorupdate" funname="add" icon="icon-add"></t:dgToolBar>
	<t:dgToolBar title="common.edit.param" langArg=" " url="userController.do?addorupdate" funname="update" icon="icon-edit"></t:dgToolBar>
