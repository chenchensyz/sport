	...
	<table style="width: 550px" cellpadding="0" cellspacing="1" class="formtable">
		<tbody>
			...
			<tr>
				...
				<td class="value"><input type="password" value="" name="newpassword" class="inputxt" plugin="passwordStrength" datatype="adminChangePassword" /> <span class="passwordStrength"
