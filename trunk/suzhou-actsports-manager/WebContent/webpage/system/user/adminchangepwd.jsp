	...
	<table style="width: 550px" cellpadding="0" cellspacing="1" class="formtable">
		<tbody>
			...
			<tr>
				...
				<td class="value"><input type="password" class="inputxt" value="" name="password" plugin="passwordStrength" datatype="adminChangePassword" errormsg="" /> <span class="passwordStrength"
