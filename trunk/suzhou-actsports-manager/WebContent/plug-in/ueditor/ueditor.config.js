...
(function () {
    ...
    //var newurl = window.location.protocol+"//"+window.location.host +"/"+"vcc-manager"+"/"+"download"+"/plug-in/ueditor/" ;
    var index = URL.search("plug");
    ...
    window.UEDITOR_CONFIG = {
        ...
        //,savePath: [ 'upload']                                                   // 如果用户不希望发送请求， 则可以在这里设置与服务器端能够对应上的目录名称列表
        ...
        ,imageManagerPath:newUrl + "jsp/"                                    //图片修正地址，同imagePath
