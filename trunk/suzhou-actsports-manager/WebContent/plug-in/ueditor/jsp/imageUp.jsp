    <%@ page language="java" contentType="text/html; charset=utf-8"
        ...
        <%@ page import="com.hbasesoft.framework.manager.wechat.guangjia.controller.Uploader" %>
...
String propertiesPath = currentPath+"/plug-in/ueditor/jsp/config.properties";
